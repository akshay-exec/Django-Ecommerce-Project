...
urlpatterns = [
    ...
    path('delivery_registration/',views.delivery_reg, name='delivery_reg'),
    ...
    path('login/admin_dashboard/customer_feedbacks',views.adm_customer_feedbacks, name='adm_customer_feedbacks'),
    path('login/admin_dashboard/delivery_portal',views.adm_delivery_portal, name='adm_delivery_portal'),
    path('login/admin_dashboard/approve_delivery',views.adm_approve_delivery, name='adm_approve_delivery'),
    path('login/admin_dashboard/adm_remove_delivery',views.adm_remove_delivery, name='adm_remove_delivery'),
    path('login/admin_dashboard/adm_delivery_user',views.adm_delivery_user, name='adm_delivery_user'),
    ...
    path('login/customer_dashboard/cart/history/feedback',views.customer_feedback, name='customer_feedback'),
    path('login/seller_dashboard/',views.seller_dashboard, name='seller_dashboard'),
    path('login/seller_dashboard/customer_feedback',views.seller_cus_feedback, name='seller_cus_feedback'),
    ...
    path('login/delivery_dashboard',views.delivery_dashboard, name='delivery_dashboard'),
]
